...
VMI_FGSM step=100:                0.5033 0.8653 0.4355
MI_CommonWeakness step=20:        0.452  0.8481 0.3833
PGD step=20:                      0.474  0.8651 0.4101
PGD step=100:                     0.5293 0.8556 0.4529
SGD:                              
...
for total_step in [10, 20, 50, 80, 100]:
    ...
    mean_acc, mean_ssim = test_transfer_attack_acc(attacker,
        get_lesson_loader(), 
        [
